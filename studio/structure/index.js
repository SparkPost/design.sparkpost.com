...
import { Visibility, Settings, PowerInput, Language } from '@sparkpost/matchbox-icons';
  ...
  S.list()
    ...
    .items([
      S.listItem()
        .title('Settings')
        .child(
          S.list().title('Settings').items([SEOSettings, Menus, HeaderSettings, FooterSettings])
        )
        .icon(Settings),
      S.divider(),
      ...pages,
